            ...
            <div className="ResultsSection__result__topbar">
              <div className="ResultsSection__add">
                <button
                  ...
                  aria-label={`Add ${event.course.shortTitle}`}
                >
                  Add
                </button>
              </div>
              <div className="ResultsSection__crn no-dark-mode">
                ...
                <button
                  onClick={() => navigator.clipboard.writeText(event.crn)}
                  aria-label={`Copy CRN ${event.crn}`}
                >
                  Copy
                </button>
              </div>
              ...
              <div className="ResultsSection__section no-dark-mode">
                {event.section}
              </div>
              ...
              <div className="ResultsSection__credit no-dark-mode">
                {event.credit}
              </div>
              <div className="ResultsSection__type no-dark-mode">
                {event.type}
              </div>
              <div className="ResultsSection__instructor no-dark-mode">
                {event.instructor}
              </div>
            </div>
            <div className="ResultsSection__result__content no-dark-mode">
              <div>
                <strong>Days:</strong> {event.days}, <strong>Time:</strong>{" "}
